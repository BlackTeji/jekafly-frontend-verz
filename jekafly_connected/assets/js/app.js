...
function showRequirements() {
    ...
    const oldAdvisory = document.getElementById('fcdo-advisory');
    if (oldAdvisory) oldAdvisory.remove();

    const advisory = fetchTravelAdvisory(dest);
    const insertBefore = document.querySelector('.checker-result-cta');
    if (advisory && insertBefore) {
        const el = document.createElement('div');
        el.id = 'fcdo-advisory';
        el.style.cssText = `display:flex;align-items:flex-start;gap:10px;background:#F8F9FE;border-left:3px solid ${advisory.color};border-radius:0 8px 8px 0;padding:12px 16px;margin:14px 0;font-size:0.83rem;color:#374151;line-height:1.55;`;
        el.innerHTML = `
            <span style="font-size:1rem;flex-shrink:0;">${advisory.icon}</span>
            <div>
                <strong style="color:${advisory.color};">US State Dept Travel Advisory</strong><br>
                ${advisory.level} —
                <a href="${advisory.url}" target="_blank" rel="noopener" style="color:#0D1560;font-weight:600;text-decoration:underline;">
                    View full advisory ↗
                </a>
            </div>`;
...
const TRAVEL_ADVISORIES = {
    'Afghanistan': { level: 4, text: 'Level 4: Do Not Travel' },
    'Albania': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Algeria': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Andorra': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Angola': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Antigua and Barbuda': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Argentina': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Armenia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Australia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Austria': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Azerbaijan': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Bahamas': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Bahrain': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Bangladesh': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Barbados': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Belarus': { level: 4, text: 'Level 4: Do Not Travel' },
    'Belgium': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Belize': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Benin': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Bhutan': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Bolivia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Bosnia and Herzegovina': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Botswana': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Brazil': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Brunei': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Bulgaria': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Burkina Faso': { level: 4, text: 'Level 4: Do Not Travel' },
    'Burundi': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Cabo Verde': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Cambodia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Cameroon': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Canada': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Central African Republic': { level: 4, text: 'Level 4: Do Not Travel' },
    'Chad': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Chile': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'China': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Colombia': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Comoros': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Costa Rica': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Croatia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Cuba': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Cyprus': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Czech Republic': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Democratic Republic of Congo': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Denmark': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Djibouti': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Dominica': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Dominican Republic': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Ecuador': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Egypt': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'El Salvador': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Equatorial Guinea': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Eritrea': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Estonia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Eswatini': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Ethiopia': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Fiji': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Finland': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'France': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Gabon': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Gambia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Georgia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Germany': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Ghana': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Greece': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Grenada': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Guatemala': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Guinea': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Guinea-Bissau': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Guyana': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Haiti': { level: 4, text: 'Level 4: Do Not Travel' },
    'Honduras': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Hungary': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Iceland': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'India': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Indonesia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Iran': { level: 4, text: 'Level 4: Do Not Travel' },
    'Iraq': { level: 4, text: 'Level 4: Do Not Travel' },
    'Ireland': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Israel': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Italy': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Ivory Coast': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Jamaica': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Japan': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Jordan': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Kazakhstan': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Kenya': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Kiribati': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Kosovo': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Kuwait': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Kyrgyzstan': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Laos': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Latvia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Lebanon': { level: 4, text: 'Level 4: Do Not Travel' },
    'Lesotho': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Liberia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Libya': { level: 4, text: 'Level 4: Do Not Travel' },
    'Liechtenstein': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Lithuania': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Luxembourg': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Madagascar': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Malawi': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Malaysia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Maldives': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Mali': { level: 4, text: 'Level 4: Do Not Travel' },
    'Malta': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Marshall Islands': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Mauritania': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Mauritius': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Mexico': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Micronesia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Moldova': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Monaco': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Mongolia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Montenegro': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Morocco': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Mozambique': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Myanmar': { level: 4, text: 'Level 4: Do Not Travel' },
    'Namibia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Nauru': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Nepal': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Netherlands': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'New Zealand': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Nicaragua': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Niger': { level: 4, text: 'Level 4: Do Not Travel' },
    'North Korea': { level: 4, text: 'Level 4: Do Not Travel' },
    'North Macedonia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Norway': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Oman': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Pakistan': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Palau': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Palestine': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Panama': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Papua New Guinea': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Paraguay': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Peru': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Philippines': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Poland': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Portugal': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Qatar': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Republic of Congo': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Romania': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Russia': { level: 4, text: 'Level 4: Do Not Travel' },
    'Rwanda': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Saint Kitts and Nevis': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Saint Lucia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Saint Vincent and the Grenadines': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Samoa': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'San Marino': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Sao Tome and Principe': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Saudi Arabia': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Senegal': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Serbia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Seychelles': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Sierra Leone': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Singapore': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Slovakia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Slovenia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Solomon Islands': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Somalia': { level: 4, text: 'Level 4: Do Not Travel' },
    'South Africa': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'South Korea': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'South Sudan': { level: 4, text: 'Level 4: Do Not Travel' },
    'Spain': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Sri Lanka': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Sudan': { level: 4, text: 'Level 4: Do Not Travel' },
    'Suriname': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Sweden': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Switzerland': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Syria': { level: 4, text: 'Level 4: Do Not Travel' },
    'Taiwan': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Tajikistan': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Tanzania': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Thailand': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Timor-Leste': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Togo': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Tonga': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Trinidad and Tobago': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Tunisia': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Turkey': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Turkmenistan': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Tuvalu': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'UAE': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Uganda': { level: 3, text: 'Level 3: Reconsider Travel' },
    'Ukraine': { level: 4, text: 'Level 4: Do Not Travel' },
    'United Kingdom': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'United States': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Uruguay': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Uzbekistan': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Vanuatu': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Vatican City': { level: 2, text: 'Level 2: Exercise Increased Caution' },
    'Venezuela': { level: 4, text: 'Level 4: Do Not Travel' },
    'Vietnam': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Yemen': { level: 4, text: 'Level 4: Do Not Travel' },
    'Zambia': { level: 1, text: 'Level 1: Exercise Normal Precautions' },
    'Zimbabwe': { level: 2, text: 'Level 2: Exercise Increased Caution' },
};

function fetchTravelAdvisory(country) {
    const entry = TRAVEL_ADVISORIES[country];
    if (!entry) return null;
    const { level, text } = entry;
    const url = 'https://travel.state.gov/en/international-travel/travel-advisories.html';
    let color, icon;
    if (level >= 4) { color = '#E31E24'; icon = '🔴'; }
    else if (level === 3) { color = '#F59E0B'; icon = '🟠'; }
    else if (level === 2) { color = '#F59E0B'; icon = '🟡'; }
    else { color = '#10B981'; icon = '🟢'; }
    return { level: text, color, icon, url };
}
